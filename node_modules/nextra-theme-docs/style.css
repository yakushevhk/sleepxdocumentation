...
.table-container:not(:first-child),blockquote:not(:first-child),p:not(:first-child){
    margin-top:1.5rem
}
hr{
    margin-top:2rem;
...
.text-orange-800{
    --tw-text-opacity:1;
    color:rgba(156,66,33,var(--tw-text-opacity))
}
.text-red-900{
    --tw-text-opacity:1;
    color:rgba(116,42,42,var(--tw-text-opacity))
}
.text-yellow-900{
    --tw-text-opacity:1;
...
.nextra-container nav a:focus,.nextra-container nav a:focus-visible,.nextra-container nav summary:focus,.nextra-container nav summary:focus-visible{
    -webkit-user-select:none;
    -moz-user-select:none;
    -ms-user-select:none;
    user-select:none;
...
.nextra-container nav a:focus-visible,.nextra-container nav summary:focus-visible{
    --tw-ring-offset-shadow:var(--tw-ring-inset) 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color);
    --tw-ring-shadow:var(--tw-ring-inset) 0 0 0 calc(3px + var(--tw-ring-offset-width)) var(--tw-ring-color);
    box-shadow:var(--tw-ring-offset-shadow),var(--tw-ring-shadow),var(--tw-shadow,0 0 transparent)
}
...
.nextra-search input::-moz-placeholder{
    --tw-text-opacity:1;
    color:rgba(203,213,224,var(--tw-text-opacity))
}
.nextra-search input:-ms-input-placeholder{
    --tw-text-opacity:1;
    color:rgba(203,213,224,var(--tw-text-opacity))
}
...
.dark .nextra-search input::-moz-placeholder{
    --tw-text-opacity:1;
    color:rgba(74,85,104,var(--tw-text-opacity))
}
.dark .nextra-search input:-ms-input-placeholder{
    --tw-text-opacity:1;
    color:rgba(74,85,104,var(--tw-text-opacity))
}
...
.nextra-search ul>:not([hidden])~:not([hidden]){
    --tw-divide-opacity:1;
...
.dark .nextra-search ul>:not([hidden])~:not([hidden]){
    --tw-divide-opacity:1;
...
.nextra-search ul a:focus li,.nextra-search ul li.active{
    --tw-bg-opacity:1;
    background-color:rgba(237,242,247,var(--tw-bg-opacity))
}
...
.dark .nextra-search ul a:focus li,.dark .nextra-search ul li.active{
    --tw-bg-opacity:1;
    background-color:rgba(45,55,72,var(--tw-bg-opacity))
}
...
pre .prism-code .token.builtin,pre .prism-code .token.char,pre .prism-code .token.constant,pre .prism-code .token.plain{
    color:#000!important
}
.dark pre .prism-code .token.builtin,.dark pre .prism-code .token.char,.dark pre .prism-code .token.constant,.dark pre .prism-code .token.plain{
    color:#fff!important
}
pre .prism-code .token.attr-value,pre .prism-code .token.string,pre .prism-code .token.url{
    color:#028265!important
}
.dark pre .prism-code .token.attr-value,.dark pre .prism-code .token.string,.dark pre .prism-code .token.url{
    color:#20bb98!important
}
pre .prism-code .token.operator,pre .prism-code .token.punctuation{
    color:#333!important
}
.dark pre .prism-code .token.operator,.dark pre .prism-code .token.punctuation{
    color:#bbb!important
}
pre .prism-code .token.function,pre .prism-code .token.number,pre .prism-code .token.tag:not(.script){
    color:#0076ff!important
}
.dark pre .prism-code .token.function,.dark pre .prism-code .token.number,.dark pre .prism-code .token.tag:not(.script){
...
.nextra-container.rtl .sidebar a,.nextra-container.rtl .sidebar button{
    text-align:right
}
...
.nextra-container.rtl article ol,.nextra-container.rtl article ul{
    margin-left:0;
    margin-right:1.5rem
}
@media (min-width:768px){
...
.dark .dark\:text-red-200{
    --tw-text-opacity:1;
    color:rgba(254,215,215,var(--tw-text-opacity))
}
